...
class MotorController(ABC):
    ...
    @abstractmethod
    def start(self, rpm: float = 550.0) -> None:
    ...
    @abstractmethod
    def go_to_position(self, position: float, speed_limit: float = 100.0) -> None:
    ...
    @abstractmethod
    def go_to_angle(self, angle: float, speed_limit: float = 100.0) -> None:
